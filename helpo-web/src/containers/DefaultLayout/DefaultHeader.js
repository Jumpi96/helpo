        ...
        <Nav className="ml-auto" navbar>
          ...
          <AppHeaderDropdown direction="down">
            ...
            <DropdownMenu right style={{ right: 'auto' }}>
              ...
              <DropdownItem onClick={<Link to="../../../src/views/Perfiles/ConsultarPerfilGenerico">Perfil</Link>}><i className="fa fa-user"></i> Perfil</DropdownItem> {/*Deberia rutear a la consulta de perfil generico*/}
