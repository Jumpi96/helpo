        ...
        <CardBody>
          <div className="row">
            <div className="col-md-8">
              ...
              <div className='row'>
                <div className="col-md-3">
                  <p style={{ textAlign: 'left' }} className='font-weight-bold' htmlFor="sexo">Sexo</p>
                </div>
                <div className="col-md-5">
                  {this.renderSexo()}
                </div>
              ...
              <div className='row'>
                <div className="col-md-3">
                  <p style={{ paddingLeft: 0, textAlign: 'left' }} className='font-weight-bold' htmlFor="gustos">Gustos</p>
                </div>
                <div className="col-md-5">
                  {this.renderGustos()}
                </div>
